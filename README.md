...
Daily snapshots of Mahsa Alert map layers in GeoJSON format, automatically published from the live database.

## Structure

Each day's data is in a folder named by date:
